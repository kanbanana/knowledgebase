...
var objectToTest = 'toastDirective';
...
describe(objectToTest, function () {
    ...
    it('directive template attribute should be correct', function () {
      directiveElem = getCompiledElement('<div toast-directive></div>');

      expect(directiveElem).toContain('<div><span>Directive in: core, with name: toastDirective</span></div>');
    });

    it('directive template element should be correct', function () {
      directiveElem = getCompiledElement('<toast-directive></toast-directive>');
