...
var objectToTest = 'articleListItemDirective';
...
describe(objectToTest, function () {
    ...
    it('directive template attribute should be correct', function () {
      directiveElem = getCompiledElement('<div article-list-item-directive></div>');

      expect(directiveElem).toContain('<div><span>Directive in: core, with name: articleListItemDirective</span></div>');
    });

    it('directive template element should be correct', function () {
      directiveElem = getCompiledElement('<article-list-item-directive></article-list-item-directive>');
