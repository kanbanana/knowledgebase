...
var objectToTest = 'confirmationModalDirective';
...
describe(objectToTest, function () {
    ...
    it('directive template attribute should be correct', function () {
      directiveElem = getCompiledElement('<div confirmation-modal-directive></div>');

      expect(directiveElem).toContain('<div><span>Directive in: core, with name: confirmationModalDirective</span></div>');
    });

    it('directive template element should be correct', function () {
      directiveElem = getCompiledElement('<confirmation-modal-directive></confirmation-modal-directive>');
