...
var paths = {
    ...
    bower: ['./public/bower_components/**/*', './public/bower_components/**/*.css', './public/bower_components/bootstrap/**/*.min.css', './public/bower_components/font-awesome/fonts/*.*', './public/bower_components/tinymce-dist/**/*'],
    destination_public: './dist/',
    destination_modules: './dist/modules/',
    destination_bower: ['./dist/bower_components/', './dist/bower_components/bootstrap/', './dist/bower_components/font-awesome/fonts/','./dist/bower_components/tinymce-dist']
};
...
gulp.task('tinymce', function() {
    gulp.src(paths.bower[4]).pipe(gulp.dest(paths.destination_bower[3]));
});
...
gulp.task('build', function () {
    runSequence(
        'clean',
        ['views', 'styles', 'img', 'resources', 'font-awesome','tinymce', 'lint', 'javascript'],
        'browserify',
        'bower-css'
    );
});
